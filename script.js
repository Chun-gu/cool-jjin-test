function result() {
    ...
    if (yes_counter == 5)
        location.href="./results/result_5.html";
    else if (yes_counter == 4)
        location.href="./results/result_4.html";
    else if (yes_counter >= 2)
        location.href="./results/result_3.html";
    else if (yes_counter == 1)
        location.href="./results/result_2.html";
    else
        location.href="./results/result_1.html";
}